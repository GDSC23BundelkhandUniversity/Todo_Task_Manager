    ...
    <>
      <section className="view-employee-intro p-3">
        <div className="container">
          <div className="row">
            <div className="col">
              <p className="h3 text-primary">View Task</p>
            </div>
          </div>
        </div>
      </section>
                  ...
                  <div className="col-md-8">
                    <ul className="list-group">
                      <li className="list-group-item list-group-item-action">
                        By: <span className="fw-bold">{employee.name}</span>
                      </li>
                      <li className="list-group-item list-group-item-action">
                        To: <span className="fw-bold">{employee.mobile}</span>
                      </li>
                      <li className="list-group-item list-group-item-action">
                        Title: <span className="fw-bold">{employee.email}</span>
                      </li>
                      <li className="list-group-item list-group-item-action">
                        Description:{" "}
                        <span className="fw-bold">{employee.title}</span>
                      </li>
                    </ul>
                  </div>
                </div>
